...
module.exports = {
  ...
  async create(req, res) {
    ...
    return res.render('recipes/create', {chefOption})
  },
  ...
  async post(req, res) {
    ...
    const filesPromise = req.files.map(file => File.create({...file, recipe_id: recipesId}))
  ...
  async edit(req, res) {
    ...
    return res.render("recipes/edit", { recipe, chefOption, files })
